                ...
                if resource_type == "keyvault.Vault":
                    outputs = {
                        ...
                        "properties": {
                            ...
                            "enableRbacAuthorization": args.inputs.get("properties", {}).get("enableRbacAuthorization", False),
                            "enableSoftDelete": args.inputs.get("properties", {}).get("enableSoftDelete", False),
                            "softDeleteRetentionInDays": args.inputs.get("properties", {}).get("softDeleteRetentionInDays", 90),
                            "enablePurgeProtection": args.inputs.get("properties", {}).get("enablePurgeProtection", False),
                        }
                    }
